...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'workflow.run': EventHandler<never, { topic: 'input'; data: never } | { topic: 'dbInsert'; data: never } | { topic: 'delay'; data: never } | { topic: 'authMiddleware'; data: never } | { topic: 'emailSend'; data: never } | { topic: 'inputValidation'; data: never }>
