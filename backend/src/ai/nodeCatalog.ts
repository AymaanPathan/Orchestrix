export const nodeCatalog = [
  ...
  {
    type: "response",
    description: "Returns HTTP response to client.",
    example: {
      id: "send_response",
      type: "response",
      data: {
    ...
    usage: "Use {{variable}} in response body for dynamic data",
  },
  {
    type: "condition",
    description: "Conditional branching based on variable value.",
    example: {
      id: "check_role",
      type: "condition",
      data: {
    ...
    usage: "Compare {{variable}} against a value",
  },
  {
    type: "transform",
    ...
    usage: "Use {{variable}} as input, produce new output variable",
  },
];
